...
document.getElementById("whatsappForm").addEventListener("submit", function (e) {
  ...
  const whatsappNumber = "919326433965"; // Replace with your actual number (no +, use country code)

  const message = `Hello Sai Prestige,%0AI'm interested in receiving updates. Please add this email: ${email}`;
